...
## Synopsis
The css selectors exercise utelizes HTML and css to style a simple page and preview the results... it ain't pretty.

## What to expect
The page loads and shows styling to different elements on the page.
## Requirements
